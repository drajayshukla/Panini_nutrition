...
fig1 = px.bar(df_numeric, x="Category", y="Seats", title="Per-Year Data by Category", text="Seats")
st.plotly_chart(fig1)

# **Section 2: Total and Textual Data**
st.write("### Total Data and Insights")
st.write("These entries provide qualitative or total insights:")
for _, row in df_textual.iterrows():
    st.write(f"**{row['Category']}**: {row['Seats']} ([Reference]({row['Reference']}))")
