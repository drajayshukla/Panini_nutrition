...
if uploaded_file:
    # Display input form after file upload
    ...
    if uploaded_image_or_pdf:
        ...
        if "image" in file_type:
            st.image(Image.open(uploaded_image_or_pdf), caption="Uploaded Image", use_column_width=True)
        elif "pdf" in file_type:
            st.write("PDF uploaded successfully. (Rendering PDFs directly in Streamlit is limited.)")
