...
try:
    ...
    st.write(f"Data last updated: {pd.Timestamp(last_modified_time, unit='s')}")
    ...
    if st.button("Refresh Data"):
        load_symptoms_data.clear()  # Clear cached data
    ...
    st.error("The required CSV file (casesheetDM.csv) was not found in the 'data' folder. Please ensure the file exists.")
